...
public class Screen extends JPanel implements KeyListener
{
	...
	public static File gattlingShotSound = new File("sounds/gattlingShot.WAV");
	public static File invaderExplosionSound = new File("sounds/invaderExplosion.WAV");
	public static File invaderShotSound = new File("sounds/invaderShot.WAV");
	public static File mysteryShipSound = new File("sounds/mysteryShip.WAV");
	public static File noAmmoSound = new File("sounds/noAmmo.WAV");
	public static File powerupPickupSound = new File("sounds/powerupPickup.WAV");
	public static File shipExplosionSound = new File("sounds/shipExplosion.WAV");
	public static File shipShotSound = new File("sounds/shipShot.WAV");
	public static File shotCollisionSound = new File("sounds/shotCollision.WAV");
	...
	public static ImageIcon invaderImg1 = new ImageIcon("images/invader3.png");
	public static ImageIcon invaderImg2 = new ImageIcon("images/invader1.png");
	public static ImageIcon invaderImg3 = new ImageIcon("images/invader2.png");
	public static ImageIcon laserCannonImg = new ImageIcon("images/laserCannon.png");
	public static ImageIcon explosionImg = new ImageIcon("images/explosion.gif");
	public static ImageIcon shotCollisionImg = new ImageIcon("images/shotCollision.gif");
	public static ImageIcon powerupImg = new ImageIcon("images/gattlingPowerup.gif");
	public static ImageIcon bunkerImg = new ImageIcon("images/bunker40.png");
	public static ImageIcon mysteryImg = new ImageIcon("images/mysteryShip.png");
	public static ImageIcon shipShotImg = new ImageIcon("images/shipShot.png");
	public static ImageIcon shipGattlingShotImg = new ImageIcon("images/gattlingShot.png");
	public static ImageIcon alienShotImg = new ImageIcon("images/alienShot.png");
	...
	//import font
	   try{
		   Font finalFont = null;
		   File gameFont = new File("fonts/PressStart2P.ttf");
		   if (gameFont.exists()){
			...
			for (int i = 0; i < screenObjects.size(); i++) {
				...
				if (obj instanceof Invader) {
					if (Math.random() < .0005 + (.0005*(level.getLevelNumber()/2))){
						...
						timer.start();
						File shotSound = new File("sounds/invaderShot.WAV");
						playSound(shotSound);
					}
				}
			}			
		...
		//press x to fire with the gattling gun
			...
			case KeyEvent.VK_X:
				if (playerShip != null && playerShip.getAmmo() > 0) {
					...
					File shotSound = new File("sounds/gattlingShot.WAV");
					playSound(shotSound);
					playerShip.decrementAmmo();
				}
				else if(playerShip != null && playerShip.getAmmo() == 0) {
					// play out of ammo sound
					File noAmmoSound = new File("sounds/noAmmo.WAV");
	...
	public void keyReleased(KeyEvent e) {
		...
		if(key == KeyEvent.VK_SPACE) {
			if (playerShip != null) {
				...
				screenObjects.add(shot);
				File shotSound = new File("sounds/shipShot.WAV");
				playSound(shotSound);
			}
		}
